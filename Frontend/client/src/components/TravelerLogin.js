...
export default class TravelerLogin extends Component {
...
<br/>
            ...
            <center><h1>Hotel Staff</h1></center> 
        ...
        <div className="form-group" style={{marginBottom:'15px'}}>
                 ...
                 <button className="btn btn-warning"><a href = "/Hotel" style = {{textDecoration:'none',color:'white',marginTop:'15px'}}>Login</a></button>
